    ...
    return (
        <div className="p-2 m-2 flex flex-col justify-around bg-gray-100 w-96 h-96 items-center">
            ...
            <div className="font-bold text-4xl">
                ...
                <div className='flex'>
                {(action == "" || action == "reset") && (<button className="m-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={() => setAction("start")}>
                        <img src="https://icons.veryicon.com/png/o/miscellaneous/massager/start-18.png" alt="Start" className='h-5 w-5'></img>
                    </button>)}
                {(action == "start" || action == "resume") && (<button className="m-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={() => setAction("pause")}>
                ...
                {(action == "pause") && (<button className="m-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={() => setAction("resume")}>
                        <img src="https://www.vhv.rs/dpng/d/413-4131015_resume-button-icon-icon-hd-png-download.png" alt="Resume" className='h-5 w-5'></img>
                    </button>)}
                {(action == "pause" || action == "start" || action == "resume") && (<button className="m-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={() => setAction("reset")}>
